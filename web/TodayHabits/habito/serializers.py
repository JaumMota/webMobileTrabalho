...
class HabitoSerializer(serializers.ModelSerializer): 
    ultima_data_feito = serializers.SerializerMethodField() # Campo para obter a última data em que o hábito foi feito
    feito = serializers.SerializerMethodField()  # Campo para verificar se o hábito foi feito hoje
